                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await widget.userDocumentReference!
                                  ...
                                  if (functions.contienePalabrasProhibidas(
                                      _model.txtNombreTextController.text)) {
                                    await showDialog(
                                      context: context,
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          ...
                                          content: const Text(
                                              'Lo sentimos, pero el nombre de usuario esta prohibido'),
                                          actions: [
                                            TextButton(
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          title:
                                              const Text('Actualizacion de Usuario'),
                                          content: const Text(
